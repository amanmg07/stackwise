...
const styles = StyleSheet.create({
  ...
  starterChips: { flexDirection: "row", flexWrap: "wrap", justifyContent: "center", gap: 8 },
  starterChip: {
    backgroundColor: colors.surface, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 10,
    borderWidth: 1, borderColor: colors.border,
  },
  starterChipText: { fontSize: 13, color: colors.accent, fontWeight: "500" },
